import { test, expect, createBaby, setWakeUpTime, addCompletedSleep, getDb, forceMorning } from './fixtures';
...
test('Stats subtracts pause time from sleep durations', async ({ page }) => {
  ...
  db.prepare("INSERT INTO sleep_log (baby_id, start_time, end_time, type) VALUES (?, ?, ?, 'nap')").run(
