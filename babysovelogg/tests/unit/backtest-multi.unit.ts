...
describe("multi-baby backtest", () => {
  ...
  it("all babies summary", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "halldis: 138 days, count 86% (118/138), naps 1.5p/1.5a, nap MAE 39.7, dur MAE 25, bed MAE 22, wake MAE 26.3, nap bias -3.3, count bias +0.03, cycle 138/0/0 (l/m/h), cut-short 8
      baby_1: 619 days, count 80% (498/619), naps 2.2p/2.4a, nap MAE 310.5, dur MAE 27.4, bed MAE 148.9, wake MAE 89.6, nap bias +294.4, count bias -0.21, cycle 619/0/0 (l/m/h), cut-short 0
      baby_2: 54 days, count 40% (19/47), naps 3.1p/3.0a, nap MAE 63, dur MAE 25.5, bed MAE 50.3, wake MAE 84.4, nap bias -3, count bias +0.13, cycle 47/0/0 (l/m/h), cut-short 0
      baby_3: 50 days, count 11% (3/28), naps 4.0p/3.2a, nap MAE 132.2, dur MAE 35.6, bed MAE 207.5, wake MAE 169.6, nap bias +5.9, count bias +0.79, cycle 28/0/0 (l/m/h), cut-short 0"
    `);
  });
  ...
  it("baby_1 per-month (longest dataset)", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "1mo: 7 days, count 0% (0/7), naps 6.0p/9.7a, nap MAE 544.5, dur MAE 39.5, bed MAE 978, wake MAE 0, nap bias +520.5, count bias -3.71, cycle 7/0/0 (l/m/h), cut-short 0
      2mo: 20 days, count 45% (9/20), naps 7.7p/8.0a, nap MAE 1061.4, dur MAE 33, bed MAE 1019.5, wake MAE 773.9, nap bias +1058.8, count bias -0.25, cycle 20/0/0 (l/m/h), cut-short 0
      ...
      10mo: 31 days, count 77% (24/31), naps 2.3p/2.2a, nap MAE 28.3, dur MAE 20.5, bed MAE 30.3, wake MAE 21.9, nap bias +3.6, count bias +0.03, cycle 31/0/0 (l/m/h), cut-short 0
      11mo: 30 days, count 97% (29/30), naps 2.0p/2.0a, nap MAE 40.7, dur MAE 19.8, bed MAE 31, wake MAE 25.7, nap bias +2.9, count bias +0.03, cycle 30/0/0 (l/m/h), cut-short 0
      12mo: 31 days, count 81% (25/31), naps 1.8p/1.6a, nap MAE 42.4, dur MAE 26.2, bed MAE 28.8, wake MAE 29.7, nap bias +1.1, count bias +0.13, cycle 31/0/0 (l/m/h), cut-short 0
      13mo: 30 days, count 100% (30/30), naps 1.0p/1.0a, nap MAE 14.7, dur MAE 21.1, bed MAE 23.7, wake MAE 29.5, nap bias -5.3, count bias 0, cycle 30/0/0 (l/m/h), cut-short 0
      14mo: 29 days, count 83% (24/29), naps 1.0p/1.2a, nap MAE 43.2, dur MAE 26.6, bed MAE 41.8, wake MAE 41.7, nap bias +7.2, count bias -0.14, cycle 29/0/0 (l/m/h), cut-short 0
      15mo: 31 days, count 100% (31/31), naps 1.0p/1.0a, nap MAE 45.4, dur MAE 26.6, bed MAE 40.4, wake MAE 48.8, nap bias +27.1, count bias 0, cycle 31/0/0 (l/m/h), cut-short 0
      ...
      17mo: 31 days, count 100% (31/31), naps 1.0p/1.0a, nap MAE 22.1, dur MAE 20.3, bed MAE 34.5, wake MAE 29.4, nap bias -6.1, count bias 0, cycle 31/0/0 (l/m/h), cut-short 0
      18mo: 27 days, count 100% (27/27), naps 1.0p/1.0a, nap MAE 35, dur MAE 27.6, bed MAE 44.3, wake MAE 27.6, nap bias +12.6, count bias 0, cycle 27/0/0 (l/m/h), cut-short 0
      19mo: 27 days, count 100% (27/27), naps 1.0p/1.0a, nap MAE 50.8, dur MAE 25.8, bed MAE 37.6, wake MAE 51.4, nap bias +36.9, count bias 0, cycle 27/0/0 (l/m/h), cut-short 0
      20mo: 29 days, count 100% (29/29), naps 1.0p/1.0a, nap MAE 25.6, dur MAE 22.8, bed MAE 30.4, wake MAE 29.8, nap bias +10.5, count bias 0, cycle 29/0/0 (l/m/h), cut-short 0
      21mo: 27 days, count 100% (27/27), naps 1.0p/1.0a, nap MAE 19.5, dur MAE 16.1, bed MAE 40.9, wake MAE 30.7, nap bias +5.1, count bias 0, cycle 27/0/0 (l/m/h), cut-short 0
      22mo: 31 days, count 100% (31/31), naps 1.0p/1.0a, nap MAE 19.7, dur MAE 28.7, bed MAE 33.2, wake MAE 31.2, nap bias +1.9, count bias 0, cycle 31/0/0 (l/m/h), cut-short 0
      23mo: 26 days, count 100% (26/26), naps 1.0p/1.0a, nap MAE 24, dur MAE 22.1, bed MAE 25.5, wake MAE 35.3, nap bias +7.8, count bias 0, cycle 26/0/0 (l/m/h), cut-short 0
      ...
      26mo: 7 days, count 100% (7/7), naps 1.0p/1.0a, nap MAE 29.7, dur MAE 13.4, bed MAE 44.1, wake MAE 46.6, nap bias +3.5, count bias 0, cycle 7/0/0 (l/m/h), cut-short 0
      27mo: 7 days, count 100% (7/7), naps 1.0p/1.0a, nap MAE 55.5, dur MAE 28, bed MAE 25.5, wake MAE 65.7, nap bias -7.9, count bias 0, cycle 7/0/0 (l/m/h), cut-short 0
  ...
  it("baby_2 per-month", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      ...
      2mo: 6 days, count 33% (2/6), naps 4.0p/3.7a, nap MAE 54, dur MAE 17.3, bed MAE 85.5, wake MAE 56.5, nap bias -16.9, count bias +0.33, cycle 6/0/0 (l/m/h), cut-short 0
      3mo: 8 days, count 38% (3/8), naps 3.0p/2.6a, nap MAE 55, dur MAE 22.8, bed MAE 99.3, wake MAE 130.5, nap bias -13.5, count bias +0.38, cycle 8/0/0 (l/m/h), cut-short 0
      4mo: 23 days, count 48% (11/23), naps 3.0p/3.2a, nap MAE 62.2, dur MAE 26.7, bed MAE 25.2, wake MAE 72.5, nap bias +20.7, count bias -0.22, cycle 23/0/0 (l/m/h), cut-short 0
      5mo: 9 days, count 33% (3/9), naps 3.0p/2.4a, nap MAE 78.1, dur MAE 32.7, bed MAE 89.5, wake MAE 166.3, nap bias -42.9, count bias +0.56, cycle 9/0/0 (l/m/h), cut-short 0
