...
describe("multi-baby backtest", () => {
  ...
  it("all babies summary", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "halldis: 82 days, count 80% (66/82), nap MAE 58.5 min, bed MAE 39.3 min, nap bias +9.5, count bias +0.07
      baby_1: 803 days, count 72% (576/803), nap MAE 109.9 min, bed MAE 324.9 min, nap bias +97.1, count bias -0.7
      baby_2: 147 days, count 37% (55/147), nap MAE 94.8 min, bed MAE 176.2 min, nap bias +62.8, count bias -0.29
      baby_3: 70 days, count 24% (17/70), nap MAE 110.7 min, bed MAE 1316.1 min, nap bias +54.5, count bias -0.24
      baby_4: 25 days, count 20% (5/25), nap MAE 84.5 min, bed MAE 0 min, nap bias +74.6, count bias +0.16
      baby_5: 41 days, count 5% (2/41), nap MAE 109.9 min, bed MAE 891.2 min, nap bias +105.4, count bias -1.02"
    `);
  });
  ...
  it("baby_1 per-month (longest dataset)", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "0mo: 15 days, count 13% (2/15), nap MAE 117.9 min, bed MAE 1393.3 min, nap bias +101.1, count bias -2.53
      1mo: 31 days, count 13% (4/31), nap MAE 109.6 min, bed MAE 424.8 min, nap bias +104.4, count bias -3.87
      2mo: 30 days, count 20% (6/30), nap MAE 91 min, bed MAE 473 min, nap bias +81.1, count bias -2.6
      3mo: 30 days, count 10% (3/30), nap MAE 85.4 min, bed MAE 330.5 min, nap bias +76.3, count bias -2.33
      4mo: 31 days, count 10% (3/31), nap MAE 139.8 min, bed MAE 888.6 min, nap bias +139.8, count bias -2.06
      5mo: 30 days, count 3% (1/30), nap MAE 149.1 min, bed MAE 849.9 min, nap bias +148.6, count bias -2.57
      6mo: 31 days, count 19% (6/31), nap MAE 251.7 min, bed MAE 1167.3 min, nap bias +251.7, count bias -1.81
      7mo: 30 days, count 33% (10/30), nap MAE 119 min, bed MAE 1117.3 min, nap bias +111.9, count bias -1.97
      8mo: 31 days, count 77% (24/31), nap MAE 32.9 min, bed MAE 875.9 min, nap bias +11.1, count bias -0.03
      9mo: 31 days, count 87% (27/31), nap MAE 22.8 min, bed MAE 923.1 min, nap bias -9.5, count bias +0.13
      10mo: 28 days, count 64% (18/28), nap MAE 41.5 min, bed MAE 310.2 min, nap bias -1.5, count bias 0
      11mo: 31 days, count 97% (30/31), nap MAE 42.6 min, bed MAE 28 min, nap bias -21.7, count bias +0.03
      12mo: 30 days, count 90% (27/30), nap MAE 39.9 min, bed MAE 35.2 min, nap bias -7.3, count bias +0.1
      13mo: 31 days, count 87% (27/31), nap MAE 33.9 min, bed MAE 38.7 min, nap bias -3, count bias +0.06
      14mo: 29 days, count 86% (25/29), nap MAE 39.7 min, bed MAE 39.7 min, nap bias +5.2, count bias -0.17
      ...
      25mo: 13 days, count 92% (12/13), nap MAE 214.5 min, bed MAE 79.2 min, nap bias +171.1, count bias -0.08
  ...
  it("baby_2 per-month", () => {
    ...
    const lines = buckets.map((b) => renderSummary(b.result, b.label));
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "0mo: 16 days, count 19% (3/16), nap MAE 129.7 min, bed MAE 771.8 min, nap bias +81.2, count bias -2.19
      1mo: 14 days, count 14% (2/14), nap MAE 104.1 min, bed MAE 1131.6 min, nap bias +104.1, count bias +0.93
      2mo: 10 days, count 20% (2/10), nap MAE 56.4 min, bed MAE 117.7 min, nap bias +45.9, count bias -0.3
      3mo: 23 days, count 48% (11/23), nap MAE 73 min, bed MAE 135.9 min, nap bias +52.6, count bias -0.7
      4mo: 31 days, count 45% (14/31), nap MAE 66.8 min, bed MAE 40.8 min, nap bias +12.7, count bias -0.1
      5mo: 27 days, count 37% (10/27), nap MAE 96.8 min, bed MAE 117.8 min, nap bias +65.7, count bias +0.41
      6mo: 23 days, count 43% (10/23), nap MAE 109 min, bed MAE 0 min, nap bias +101.7, count bias -0.39
