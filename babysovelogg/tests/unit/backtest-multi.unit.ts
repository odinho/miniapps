...
describe("multi-baby backtest", () => {
  ...
  it("all babies summary", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "halldis: 112 days, count 85% (95/112), nap MAE 41.3, dur MAE 24.3, bed MAE 21.4, wake MAE 25.2, nap bias -3.8, count bias +0.04
      baby_1: 619 days, count 80% (498/619), nap MAE 310.5, dur MAE 27.4, bed MAE 148.9, wake MAE 89.6, nap bias +294.4, count bias -0.21
      baby_2: 54 days, count 40% (19/47), nap MAE 63, dur MAE 25.5, bed MAE 50.3, wake MAE 84.4, nap bias -3, count bias +0.13
      baby_3: 50 days, count 11% (3/28), nap MAE 132.2, dur MAE 35.6, bed MAE 207.5, wake MAE 169.6, nap bias +5.9, count bias +0.79"
    `);
  });
  ...
  it("baby_1 per-month (longest dataset)", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "1mo: 7 days, count 0% (0/7), nap MAE 544.5, dur MAE 39.5, bed MAE 978, wake MAE 0, nap bias +520.5, count bias -3.71
      2mo: 20 days, count 45% (9/20), nap MAE 1061.4, dur MAE 33, bed MAE 1019.5, wake MAE 773.9, nap bias +1058.8, count bias -0.25
      3mo: 23 days, count 17% (4/23), nap MAE 552, dur MAE 31.6, bed MAE 488.5, wake MAE 731.7, nap bias +552, count bias -0.78
      4mo: 19 days, count 0% (0/19), nap MAE 366, dur MAE 32.1, bed MAE 459.2, wake MAE 457.2, nap bias +361.5, count bias -2.05
      5mo: 13 days, count 8% (1/13), nap MAE 582.7, dur MAE 31, bed MAE 1312.3, wake MAE 916.7, nap bias +582.2, count bias -2.08
      6mo: 17 days, count 35% (6/17), nap MAE 316.8, dur MAE 37.8, bed MAE 999.5, wake MAE 434.9, nap bias +312.1, count bias -1.41
      7mo: 28 days, count 68% (19/28), nap MAE 107.7, dur MAE 25.2, bed MAE 83.6, wake MAE 58.8, nap bias +63, count bias +0.11
      8mo: 31 days, count 77% (24/31), nap MAE 27.1, dur MAE 20.1, bed MAE 25.2, wake MAE 22.2, nap bias +11.4, count bias -0.03
      9mo: 28 days, count 75% (21/28), nap MAE 28, dur MAE 20.4, bed MAE 29.4, wake MAE 22.2, nap bias +3.6, count bias +0.11
      10mo: 31 days, count 77% (24/31), nap MAE 28.3, dur MAE 20.5, bed MAE 30.3, wake MAE 21.9, nap bias +3.6, count bias +0.03
      11mo: 30 days, count 97% (29/30), nap MAE 40.7, dur MAE 19.8, bed MAE 31, wake MAE 25.7, nap bias +2.9, count bias +0.03
      12mo: 31 days, count 81% (25/31), nap MAE 42.4, dur MAE 26.2, bed MAE 28.8, wake MAE 29.7, nap bias +1.1, count bias +0.13
      13mo: 30 days, count 100% (30/30), nap MAE 14.7, dur MAE 21.1, bed MAE 23.7, wake MAE 29.5, nap bias -5.3, count bias 0
      14mo: 29 days, count 83% (24/29), nap MAE 43.2, dur MAE 26.6, bed MAE 41.8, wake MAE 41.7, nap bias +7.2, count bias -0.14
      15mo: 31 days, count 100% (31/31), nap MAE 45.4, dur MAE 26.6, bed MAE 40.4, wake MAE 48.8, nap bias +27.1, count bias 0
      16mo: 29 days, count 100% (29/29), nap MAE 20.8, dur MAE 24.3, bed MAE 33.6, wake MAE 35.1, nap bias +5.7, count bias 0
      17mo: 31 days, count 100% (31/31), nap MAE 22.1, dur MAE 20.3, bed MAE 34.5, wake MAE 29.4, nap bias -6.1, count bias 0
      ...
      21mo: 27 days, count 100% (27/27), nap MAE 19.5, dur MAE 16.1, bed MAE 40.9, wake MAE 30.7, nap bias +5.1, count bias 0
      ...
      26mo: 7 days, count 100% (7/7), nap MAE 29.7, dur MAE 13.4, bed MAE 44.1, wake MAE 46.6, nap bias +3.5, count bias 0
      27mo: 7 days, count 100% (7/7), nap MAE 55.5, dur MAE 28, bed MAE 25.5, wake MAE 65.7, nap bias -7.9, count bias 0
  ...
  it("baby_2 per-month", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      ...
      2mo: 6 days, count 33% (2/6), nap MAE 54, dur MAE 17.3, bed MAE 85.5, wake MAE 56.5, nap bias -16.9, count bias +0.33
      3mo: 8 days, count 38% (3/8), nap MAE 55, dur MAE 22.8, bed MAE 99.3, wake MAE 130.5, nap bias -13.5, count bias +0.38
      4mo: 23 days, count 48% (11/23), nap MAE 62.2, dur MAE 26.7, bed MAE 25.2, wake MAE 72.5, nap bias +20.7, count bias -0.22
      5mo: 9 days, count 33% (3/9), nap MAE 78.1, dur MAE 32.7, bed MAE 89.5, wake MAE 166.3, nap bias -42.9, count bias +0.56
