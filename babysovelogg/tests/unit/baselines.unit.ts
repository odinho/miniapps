...
describe("baseline comparison", () => {
  it("all strategies summary", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "engine: 112 days, count 85% (95/112), nap MAE 41.4, dur MAE 24.3, bed MAE 22.7, wake MAE 25.2, nap bias -1.8, count bias +0.04
  ...
  it("per-month breakdown — engine vs baselines", () => {
    ...
    expect(lines.join("\n\n")).toMatchInlineSnapshot(`
      ...
      engine 9mo: 31 days, count 87% (27/31), nap MAE 50.5, dur MAE 26.2, bed MAE 25.9, wake MAE 26.2, nap bias -6.2, count bias 0
