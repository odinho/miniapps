...
describe("baseline comparison", () => {
  it("all strategies summary", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "engine: 112 days, count 85% (95/112), nap MAE 41.4, dur MAE 24.3, bed MAE 21.4, wake MAE 25.2, nap bias -1.8, count bias +0.04
  ...
  it("per-month breakdown — engine vs baselines", () => {
    ...
    expect(lines.join("\n\n")).toMatchInlineSnapshot(`
      ...
      engine 9mo: 31 days, count 87% (27/31), nap MAE 50.5, dur MAE 26.2, bed MAE 25.2, wake MAE 26.2, nap bias -6.2, count bias 0
      engine 10mo: 17 days, count 94% (16/17), nap MAE 29.4, dur MAE 27, bed MAE 19.4, wake MAE 23, nap bias +3.7, count bias -0.06
      ...
      weighted 9mo: 31 days, count 87% (27/31), nap MAE 85.5, dur MAE 29.3, bed MAE 61.8, wake MAE 26.2, nap bias -71.7, count bias 0
