...
describe("baseline comparison", () => {
  it("all strategies summary", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      "engine: 82 days, count 80% (66/82), nap MAE 58.5 min, bed MAE 39.3 min, nap bias +9.5, count bias +0.07
      age-default: 82 days, count 66% (54/82), nap MAE 70 min, bed MAE 54.9 min, nap bias -27.3, count bias +0.22
      yesterday: 82 days, count 73% (60/82), nap MAE 65.4 min, bed MAE 26.1 min, nap bias +14.1, count bias +0.02
      3d-avg: 82 days, count 79% (65/82), nap MAE 57.9 min, bed MAE 41.3 min, nap bias +9.4, count bias +0.06
      weighted: 82 days, count 80% (66/82), nap MAE 60.3 min, bed MAE 43.2 min, nap bias -1.6, count bias +0.07"
    `);
  });
  ...
  it("per-month breakdown — engine vs baselines", () => {
    ...
    expect(lines.join("\n\n")).toMatchInlineSnapshot(`
      "engine 6mo: 5 days, count 60% (3/5), nap MAE 49.1 min, bed MAE 61.5 min, nap bias +32.1, count bias -0.4
      engine 7mo: 31 days, count 74% (23/31), nap MAE 51 min, bed MAE 43.8 min, nap bias -6.6, count bias +0.13
      engine 8mo: 28 days, count 89% (25/28), nap MAE 34.1 min, bed MAE 26.5 min, nap bias +11.4, count bias +0.11
      engine 9mo: 18 days, count 83% (15/18), nap MAE 148.7 min, bed MAE 44.3 min, nap bias +38.1, count bias +0.06

      age-default 6mo: 5 days, count 20% (1/5), nap MAE 40 min, bed MAE 44.9 min, nap bias +25.6, count bias -0.8
      age-default 7mo: 31 days, count 84% (26/31), nap MAE 68.6 min, bed MAE 64.9 min, nap bias -50.7, count bias +0.1
      age-default 8mo: 28 days, count 89% (25/28), nap MAE 37.2 min, bed MAE 36.1 min, nap bias -23.8, count bias +0.11
      age-default 9mo: 18 days, count 11% (2/18), nap MAE 135.2 min, bed MAE 68.8 min, nap bias -12.4, count bias +0.89

      yesterday 6mo: 5 days, count 40% (2/5), nap MAE 52.8 min, bed MAE 32 min, nap bias +14.5, count bias -0.2
      yesterday 7mo: 31 days, count 74% (23/31), nap MAE 68.3 min, bed MAE 28.5 min, nap bias +10.2, count bias 0
      yesterday 8mo: 28 days, count 79% (22/28), nap MAE 46.4 min, bed MAE 25.4 min, nap bias -3.2, count bias +0.07
      yesterday 9mo: 18 days, count 72% (13/18), nap MAE 112.6 min, bed MAE 21.2 min, nap bias +67.5, count bias +0.06

      3d-avg 6mo: 5 days, count 40% (2/5), nap MAE 43.3 min, bed MAE 54.1 min, nap bias +9.6, count bias -0.2
      3d-avg 7mo: 31 days, count 71% (22/31), nap MAE 56.6 min, bed MAE 48.6 min, nap bias +3.6, count bias +0.1
      3d-avg 8mo: 28 days, count 89% (25/28), nap MAE 39.4 min, bed MAE 29.6 min, nap bias -6.9, count bias +0.11
      3d-avg 9mo: 18 days, count 89% (16/18), nap MAE 121.6 min, bed MAE 42.5 min, nap bias +70.8, count bias 0

      weighted 6mo: 5 days, count 60% (3/5), nap MAE 41.7 min, bed MAE 59.5 min, nap bias +21.8, count bias -0.4
      weighted 7mo: 31 days, count 74% (23/31), nap MAE 51.1 min, bed MAE 45.9 min, nap bias -6.1, count bias +0.13
      weighted 8mo: 28 days, count 89% (25/28), nap MAE 33.4 min, bed MAE 31.2 min, nap bias +10.6, count bias +0.11
      weighted 9mo: 18 days, count 83% (15/18), nap MAE 168 min, bed MAE 51.8 min, nap bias -34.6, count bias +0.06"
    `);
  });
});
