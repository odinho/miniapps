  ...
  it("renders consistent predictions across the day", () => {
    ...
    expect(runSweep(arch, scenarios)).toMatchInlineSnapshot(`
      ...
      scenario: pristine 06:30 just woke
        ...
        nextNap: 08:50 (+2h 20m)
        bedtime: 19:15 (+12h 45m)
        predictedNaps: 08:50-09:35, 12:10-13:20, 15:55-16:35
      ...
      scenario: 10:00 after first nap
        ...
        strategy: routine_schedule
        nextNap: 12:10 (+2h 10m)
        bedtime: 19:15 (+9h 15m)
        predictedNaps: 12:10-13:20, 15:55-16:35
        napsAllDone: false (3 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
  ...
  it("renders consistent predictions for normal day + cut-short matrix", () => {
    ...
    expect(runSweep(arch, scenarios)).toMatchInlineSnapshot(`
      ...
      scenario: 12:00 active nap (started 11:30)
        ...
        strategy: routine_schedule
        nextNap: 19:30 (+7h 30m)
        bedtime: 19:30 (+7h 30m)
        predictedNaps: none
      ...
      scenario: active comeback at 14:35 after 28m cs
        ...
        strategy: routine_schedule
        nextNap: 19:43 (+5h 03m)
        bedtime: 19:43 (+5h 03m)
        predictedNaps: none
        napsAllDone: true (1 expected)
      ...
      scenario: May-8 bug: 46m cs at 09:20-10:07, now 16:22
        ...
        strategy: routine_schedule
        nextNap: 19:30 (+3h 08m)
        bedtime: 19:30 (+3h 08m)
        predictedNaps: none
        napsAllDone: true (1 expected)
        expectedNapEnd: none
        expectedNightEnd: none
      ...
      scenario: May-8 bug: same cs, now 17:30
        ...
        inputs: wake=06:00 done=[09:20-10:06!] target=19:30
        strategy: routine_schedule
        nextNap: 19:30 (+2h 00m)
        bedtime: 19:30 (+2h 00m)
        predictedNaps: none
        napsAllDone: true (1 expected)
        expectedNapEnd: none
        expectedNightEnd: none
  ...
  it("renders adapter-shape predictions across the day", () => {
    ...
    expect(runSweep(arch, scenarios)).toMatchInlineSnapshot(`
      ...
      scenario: 06:30 just woke, fresh day
        ...
        nextNap: 08:18 (+1h 48m)
        bedtime: 19:36 (+13h 06m)
        predictedNaps: 08:18-09:08, 11:07-12:02, 14:06-14:56, 16:29-17:14
      ...
      scenario: 10:00 after first nap
        ...
        strategy: emerging_rhythm
        nextNap: 11:07 (+1h 07m)
        bedtime: 19:45 (+9h 45m)
        predictedNaps: 11:07-12:02, 14:06-14:56, 16:29-17:14
        napsAllDone: false (4 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
      ...
      scenario: 12:30 mid-day after 2 naps
        ...
        strategy: emerging_rhythm
        nextNap: 14:06 (+1h 36m)
        bedtime: 19:45 (+7h 15m)
        predictedNaps: 14:06-14:56, 16:29-17:14
        napsAllDone: false (4 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
      ...
      scenario: 14:30 active nap 3
        ...
        strategy: emerging_rhythm
        nextNap: 16:29 (+1h 59m)
        bedtime: 19:45 (+5h 15m)
        predictedNaps: 16:29-17:14
        napsAllDone: false (4 expected)
      ...
      scenario: 17:30 after 4 naps, evening
        ...
        strategy: emerging_rhythm
        nextNap: 19:45 (+2h 15m)
        bedtime: 19:45 (+2h 15m)
        predictedNaps: none
  ...
  it("produces sane predictions without target_bedtime", () => {
    ...
    expect(runSweep(arch, scenarios)).toMatchInlineSnapshot(`
      ...
      scenario: 06:00 fresh day, no target
        ...
        strategy: routine_schedule
        nextNap: 09:30 (+3h 30m)
        bedtime: 19:09 (+13h 09m)
        predictedNaps: 09:30-10:50, 13:46-15:06
      ...
      scenario: 11:00 after first nap
        ...
        strategy: routine_schedule
        nextNap: 13:46 (+2h 46m)
        bedtime: 19:02 (+8h 02m)
        predictedNaps: 13:46-15:06
        napsAllDone: false (2 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
      ...
      scenario: 06:00 same day with target=18:00 override
        ...
        strategy: routine_schedule
        nextNap: 09:04 (+3h 04m)
        bedtime: 18:54 (+12h 54m)
        predictedNaps: 09:04-10:24, 13:24-14:44
        napsAllDone: false (2 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
  ...
  it("handles sparse history gracefully", () => {
    ...
    expect(runSweep(arch, scenarios)).toMatchInlineSnapshot(`
      ...
      scenario: 06:30 sparse day start
        ...
        predictedNaps: 10:00-11:04, 14:34-15:38
        napsAllDone: false (2 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
      ...
      scenario: 12:00 after first nap
        ...
        strategy: emerging_rhythm
        nextNap: 14:34 (+2h 34m)
        bedtime: 20:00 (+8h 00m)
        predictedNaps: 14:34-15:38
        napsAllDone: false (2 expected)
        expectedNapEnd: none
        expectedNightEnd: none
        rescueNap: none
...
describe("paired-baseline invariants", () => {
  ...
  it("target_bedtime convergence: 14-day simulation slides toward target", () => {
    ...
    expect(trail.join("\n")).toMatchInlineSnapshot(`
      ...
      day 8: bedtime=18:31
      day 9: bedtime=18:27
      day 10: bedtime=18:23
      day 11: bedtime=18:19
      day 12: bedtime=18:15
      day 13: bedtime=18:11"
    `);
  ...
  it("renders day plan across target_bedtime variants", () => {
    ...
    expect(runSettingsSweep(arch, settings, scenarios)).toMatchInlineSnapshot(`
      ...
      scenario: 13:30 right after full nap
        ...
        strategy: routine_schedule
        nextNap: 19:15 (+5h 45m)
        bedtime: 19:15 (+5h 45m)
        predictedNaps: none
        napsAllDone: true (1 expected)
        expectedNapEnd: none
        expectedNightEnd: none
      ...
      scenario: 13:30 right after full nap
        ...
        strategy: routine_schedule
        nextNap: 20:00 (+6h 30m)
        bedtime: 20:00 (+6h 30m)
        predictedNaps: none
        napsAllDone: true (1 expected)
        expectedNapEnd: none
        expectedNightEnd: none
      ...
      scenario: 16:00 napsAllDone
        ...
        inputs: wake=06:00 done=[11:30-13:20] target=21:00
        strategy: routine_schedule
        nextNap: 20:00 (+4h 00m)
        bedtime: 20:00 (+4h 00m)
        predictedNaps: none
        napsAllDone: true (1 expected)
        expectedNapEnd: none
        expectedNightEnd: none
  ...
  it("each archetype satisfies cross-archetype expectations", () => {
    ...
    expect(blocks).toMatchInlineSnapshot(`
      ...
      scenario: midday no sleeps logged at 13:00
        ...
        inputs: wake=06:00 target=19:45
        strategy: emerging_rhythm
        nextNap: 14:06 (+1h 06m)
        bedtime: 19:16 (+6h 16m)
        predictedNaps: 14:06-14:56, 16:29-17:14
        napsAllDone: false (4 expected)
        expectedNapEnd: none
        expectedNightEnd: none
