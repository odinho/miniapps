...
describe("baseline", () => {
  ...
  it("per-month breakdown", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      ...
      8mo: 28 days, count 89% (25/28), nap MAE 27, dur MAE 18.8, bed MAE 18.1, wake MAE 21.8, nap bias +4.2, count bias +0.11
  ...
  it("per-month with manual nap count", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      ...
      8mo manual=2: 28 days, count 89% (25/28), nap MAE 27, dur MAE 18.8, bed MAE 18.1, wake MAE 21.8, nap bias +4.2, count bias +0.11
  ...
  it("warm-up curve", () => {
    ...
    expect(lines.join("\n")).toMatchInlineSnapshot(`
      ...
      day 15+: 72 days, count 86% (62/72), nap MAE 39.8, dur MAE 22.4, bed MAE 21.9, wake MAE 26.2, nap bias -0.5, count bias +0.08"
    `);
  });
