...
function makeState(overrides: Partial<AppState> = {}): AppState {
	return {
		baby: { id: 1, name: 'Halldis', birthdate: '2025-06-01', created_at: '2025-06-01', custom_nap_count: null, potty_mode: 0, timezone: null, target_bedtime: null, created_by_event_id: null, updated_by_event_id: null },
		activeSleep: null,
		todaySleeps: [],
